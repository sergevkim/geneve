...
from geneve.models import StyleGAN2Discriminator
from geneve.models import StyleGAN2Generator
...
class StyleGAN2Module(pl.LightningModule):
    def __init__(self, config):
        ...
        self.config = config
        self.G = StyleGAN2Generator(config.latent_dim, config.latent_dim, config.num_mapping_layers, config.image_size, 3, synthesis_layer=config.generator)
        self.D = StyleGAN2Discriminator(config.image_size, 3)
